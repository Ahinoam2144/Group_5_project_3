...
def eval_spatial_argo(selected_mems_dict, recon_output_dir, init_date, fin_date):
...
def eval_spatial_argo_clim(selected_mems_dict, recon_output_dir, init_date, fin_date):
